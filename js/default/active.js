(function ($) {
    ...
    // :: Navbar
    $("#fitalphazNavbarToggler").on("click", function () {
    ...
    // :: Owl Carousel Slides
    if ($.fn.owlCarousel) {
        var fitalphazowlslides = $('.fitalphaz-owl-carousel-slides');
        fitalphazowlslides.owlCarousel({
            items: 1,
            margin: 0,
            loop: true,
            autoplay: true,
